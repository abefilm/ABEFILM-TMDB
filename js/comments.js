document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- THE FIX: Check if the comment section exists before running any code ---
    const commentSection = document.getElementById('comment-section');

    // If the main comment container isn't on this page (e.g., the homepage),
    // stop this script from running to prevent errors.
    if (!commentSection) {
        // console.log("Comment section not found. Comment script will not execute.");
        return; // Exit the script early
    }
    // --- END OF FIX ---


    // The rest of your original script will now only run on the correct pages.
   ...
   const avatarData = {
      person: [
        "https://cdn-icons-png.flaticon.com/128/4139/4139981.png", "https://cdn-icons-png.flaticon.com/128/4140/4140057.png", "https://cdn-icons-png.flaticon.com/128/4140/4140077.png", "https://cdn-icons-png.flaticon.com/128/2202/2202112.png", "https://cdn-icons-png.flaticon.com/128/4140/4140061.png", "https://cdn-icons-png.flaticon.com/128/4140/4140037.png", "https://cdn-icons-png.flaticon.com/128/4140/4140051.png", "https://cdn-icons-png.flaticon.com/128/4139/4139951.png", "https://cdn-icons-png.flaticon.com/128/4140/4140060.png", "https://cdn-icons-png.flaticon.com/128/6997/6997662.png", "https://cdn-icons-png.flaticon.com/128/4140/4140040.png", "https://cdn-icons-png.flaticon.com/128/4140/4140047.png"
      ],
      animal: [
